...
import type { TUpdateUserSchema, TUser, TUserListResponse } from "@/schema/user.schema";
...
const getUserList = async (params?: GetUserListParams) => await apiRequest.get<BaseResponse<TUserListResponse>>(API_SUFFIX.USER_API, { params });
